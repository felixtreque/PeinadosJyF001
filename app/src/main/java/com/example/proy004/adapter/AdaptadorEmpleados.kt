...
class AdaptadorEmpleados(private val context: Context, private val cursor: Cursor) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_empleado, parent, false)
